        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs nav-justified">
                    ...
                    {{-- {{  env('APP_GLASSES') }} --}}
                    @if (env('APP_GLASSES')==1)
                    <li class="
                            @if(!empty($view_type) &&  $view_type == 'follow_up')
                                active
                            @else
                                ''
                            @endif
                            ">
                        <a href="#follow_up_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-eye" aria-hidden="true"></i> @lang('lang_v1.follow-ups')</a>
                    </li>
                    @endif
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane
                            ...
                            @endif"
                        id="follow_up_tab">
                        @include('contact.partials.follow_up_tab')
                    </div>
...
<!-- document & note.js -->
@include('follow_up.follow_up_js')
@if(!empty($contact_view_tabs))
    @foreach($contact_view_tabs as $key => $tabs)
        @foreach ($tabs as $index => $value)
            @if(!empty($value['module_js_path']))
