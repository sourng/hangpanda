...
<div class="col-md-6 col-sm-6 col-xs-6 text-right align-right @if(!empty($for_pdf)) width-50 f-left @endif">
	...
	<small>{{dateKhmer($ledger_details['start_date'])}} @lang('lang_v1.to') {{dateKhmer($ledger_details['end_date'])}}</small>
	{{-- <small>{{numberToKhmerMonth('02')}}</small> --}}
	<hr>
