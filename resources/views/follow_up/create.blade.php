<div class="modal-dialog modal-lg" role="document">
    {!! Form::open(['action' => 'FollowUpController@store', 'id' => 'follow_up_form', 'method' => 'post']) !!}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('description', null, ['class' => 'form-control ', 'id' => 'follow_up_description']); !!}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="dropzone" id="followUpload"></div>
                    </div>
                    <input type="hidden" id="follow_ups_media" name="file_name[]" value="">
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
