...
function numberToKhmerMonth($number){
    $khmer_months = array('01'=>'មករា','02'=>'កុម្ភះ','03'=>'មិនា','04'=>'មេសា','05'=>'ឧសភា','06'=>'មិថុនា','07'=>'កក្កដា','08'=>'សីហា','09'=>'កញ្ញា','10'=>'តុលា','11'=>'វិច្ឆកា','12'=>'ធ្នូ');
 ...
 * @param date $date
 */
function dateKhmer($date){        
    $date =  new Carbon(str_replace('/','-',$date));
    $date->setLocale('km');
    return convertToKhmerNumber($date->translatedFormat('d/F/Y'));    
}

function convertToKhmerNumber($string)
{
    $numbers     = array(
        0 => '០',
        1 => '១',
