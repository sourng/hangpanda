...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    //common controller for follow up
    Route::get('get-follow-up-page', 'FollowUpController@getFollowUpIndexPage');
    Route::post('post-follow-upload', 'FollowUpController@postMedia');
